...
from syntheval.generation.controllable.argument_utils import TrainingArguments, PrivacyArguments, ModelArguments, DataArguments
...
def set_default_training_args(dry_run = False, dry_test_run = False):
    return TrainingArguments(output_dir = "/data/projects/syntheval/models/",
